package com.shop.shoporder.service.lib;
...
public class RedisStringService {
    ...
    public String set(String key, String val) {
        ...
        String valget = stringRedisTemplate.opsForValue().get(key);
        System.out.println("\nvalget" + valget);
     ...
     * set(K key, V value)
     */
    public void set(String key, String val, Long tt) {
        // 也可以向redis里存入数据和设置缓存时间
        stringRedisTemplate.opsForValue().set(key, val, tt, TimeUnit.SECONDS);
    }
